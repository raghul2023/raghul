...
const About = () =>{
  ...
  >
        ...
        <div className="max-w-[650px] flex  flex-col">
            ...
            I’m an MBA Finance student with a strong passion for investment banking front office roles. I have worked on financial analysis, valuation, and risk assessment projects, including CCA, DCF, and market research. Through internships and projects, I’ve gained hands-on experience in analyzing financial data and making strategic recommendations. I previously interned at Zielhoch, where I developed insights into financial strategy . Beyond academics, I enjoy exploring fintech innovations, staying updated on market trends, and learning advanced valuation techniques. I’m always eager to take on new challenges and grow in the finance industry by applying my skills to real-world scenarios.
            </p>
